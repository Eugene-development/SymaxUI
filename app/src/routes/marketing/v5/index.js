const title_Marketing_v5 = 'Замер'
const text_Marketing_v5 = 'Осуществляем обмер помещения с учётом кривизны стен и полов. Рекомендуем исходя из полученных данных и ваших пожеланий наиболее приемлемый вариант мебели.'
