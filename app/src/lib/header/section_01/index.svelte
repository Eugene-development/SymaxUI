                ...
                <div class="mr-2">
                    <div class=" flex items-center md:ml-2">
                        ...
                        <div class="items-center">
                            <div class="flex">
                                <div class="flex space-x-1 bg-gray-700 hover:bg-gray-600 px-2 py-0.5 mr-1.5 rounded-md items-center antialiased">
                                    <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-50" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    ...
                                    <a href="tel:+74951475550" class=" text-gray-50 text-base font-bold ">{phone}</a>
                                </div>
                                <div class="flex space-x-1 bg-gray-700 hover:bg-gray-600 px-2 py-0.5 mr-1.5 rounded-md items-center antialiased">
                                    <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-50" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    ...
                                    <p class="text-gray-50 text-base  font-bold">{email}</p>
                                </div>
                            </div>
                        </div>
