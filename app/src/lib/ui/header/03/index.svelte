<script>
	...
	export let parentPage;
	export let parentPageLink;
	export let currentPage;
</script>

<div class="relative">
	<div class="absolute inset-0">
		<img class="w-full h-full object-cover grayscale" src={pathImg} alt="фото фона" />
			...
			<ol class="max-w-screen-xl w-full mx-auto pb-16 flex space-x-4">
				...
				{#if (parentPage)}
					<li class="flex">
						<div class="flex items-center">
							...
							<a href="{parentPageLink}" class="ml-4 text-sm font-medium text-gray-100 hover:text-gray-200">{parentPage}</a>
						</div>
					</li>
				{/if}
				...
				<li class="flex">
					<div class="flex items-center">
						...
						<span class="ml-4 text-sm font-medium text-gray-100 hover:text-gray-200" aria-current="page">{currentPage}</span>
					</div>
				</li>
			</ol>
