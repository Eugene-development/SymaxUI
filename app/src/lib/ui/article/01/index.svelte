...
<div class="py-16 bg-gray-50 overflow-hidden">
    <div class="max-w-7xl mx-auto px-4 space-y-8 sm:px-6 lg:px-8">
        <div class="text-base max-w-prose mx-auto lg:max-w-none">
            <h2 class="text-base text-slate-600 font-semibold tracking-wide uppercase">{overhead}</h2>
            <p class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-slate-800 sm:text-4xl">{header}</p>
        </div>
        <div class="lg:grid lg:grid-cols-2 lg:gap-8 lg:items-start">
            ...
            <div class="mt-12 relative text-base max-w-prose mx-auto lg:mt-0 lg:max-w-none">
                ...
                {#each testimonials as { name, text, avatar, alt }}
                    <blockquote class="mb-16 relative bg-white rounded-lg shadow-lg">
                        <div class="rounded-t-lg px-6 py-8 sm:px-10 sm:pt-10 sm:pb-8 ">
                            <div class="relative text-lg text-gray-700 font-medium mt-8">
                                <svg class="absolute top-0 left-0 transform -translate-x-3 -translate-y-2 h-8 w-8 text-slate-50" fill="currentColor" viewBox="0 0 32 32" aria-hidden="true">
                        ...
                        <div class="relative flex items-center sm:items-start bg-slate-800 rounded-b-lg not-italic py-5 px-6 sm:py-5 sm:pl-12 sm:pr-10 sm:mt-10">
                            <div class="relative rounded-full border-2 border-white sm:absolute sm:top-0 sm:transform sm:-translate-y-1/2">
                                <img class="w-12 h-12 sm:w-20 sm:h-20 rounded-full bg-main" src="{avatar}" alt="{alt}">
                            </div>
