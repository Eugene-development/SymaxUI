<script>
	...
	onMount(async () => {
		await gsapTextToRight(boxParam.box1, boxParam.box2);
	});
</script>
					...
					>
						<div>
							...
							>
								...
								приобрести только внутреннее наполнение или сами двери купе.
							</p>
							<p
								class="mt-3 text-base text-gray-300 sm:mt-5 sm:text-base lg:text-base xl:text-base antialiased"
								id={boxParam.box2}
							>
								...
								на кухонные гарнитуры вне зависимости от ценовой категории.
							</p>
						...
						<div class="bg-white sm:max-w-md sm:w-full sm:mx-auto sm:rounded-lg sm:overflow-hidden">
							...
							<div class="px-4 py-6 bg-gray-50 border-t-2 border-gray-200 sm:px-10">
								<p class="text-xs leading-5 text-gray-500 text-center">
									После отправки заявки с вами свяжется менеджер <strong>Евгений</strong> для уточнения
									нюансов
								</p>
							</div>
						</div>
